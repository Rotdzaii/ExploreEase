...
export const getStyles = ({ isDarkMode, screenWidth }: { isDarkMode: boolean; screenWidth: number }) => {
  ...
  return StyleSheet.create({
    ...
    bgCircle1: {
      ...
      height: s(420),
      borderRadius: s(210),
      backgroundColor: isDarkMode ? 'rgba(0, 119, 182, 0.12)' : 'rgba(0, 180, 216, 0.16)',
    ...
    bgCircle2: {
      ...
      height: s(420),
      borderRadius: s(210),
      backgroundColor: isDarkMode ? 'rgba(0, 180, 216, 0.10)' : 'rgba(0, 180, 216, 0.14)',
    ...
    loadingIndicator: {
      ...
      height: s(10),
      borderRadius: 999,
      backgroundColor: isDarkMode ? 'rgba(0, 119, 182, 0.34)' : 'rgba(0, 119, 182, 0.28)',
      borderWidth: 1,
      borderColor: 'rgba(0, 119, 182, 0.42)',
      opacity: 0.9,
    },
    ...
    avatarRing: {
      ...
      padding: s(2),
      borderWidth: 2,
      borderColor: isDarkMode ? 'rgba(0,119,182,0.35)' : 'rgba(0,119,182,0.30)',
    ...
    notifBtn: {
      ...
      justifyContent: 'center',
      alignItems: 'center',
      backgroundColor: isDarkMode ? 'rgba(0,119,182,0.12)' : 'rgba(0,119,182,0.10)',
      borderWidth: 1,
      borderColor: isDarkMode ? 'rgba(0,119,182,0.26)' : 'rgba(0,119,182,0.24)',
    },
    notifDot: {
      position: 'absolute',
      top: s(10),
    ...
    searchBlur: {
      ...
      borderBottomColor: 'rgba(0, 119, 182, 0.45)',
      overflow: 'hidden',
      backgroundColor: colors.cardBg,
    },
    searchBlurFocused: {
      borderColor: 'rgba(0, 119, 182, 0.5)',
      borderBottomColor: 'rgba(0, 119, 182, 0.65)',
      ...Platform.select({ web: { boxShadow: '0 10px 30px rgba(0,119,182,0.18)' } as any }),
    },
    ...
    catIconActive: { backgroundColor: 'rgba(0, 119, 182, 0.12)', borderColor: ExploreEaseColors.primary },
    ...
    featuredRatingBadge: {
      ...
      alignItems: 'center',
      gap: s(6),
      backgroundColor: 'rgba(0, 119, 182, 0.22)',
